...
const MovieDetails = () => {
  ...
  return <>
    <div className="grid grid-cols-1 md:grid-cols-[20%_1fr] gap-6 mb-6">
      <img src="/public/Karate_Kid_Legends_Poster.jpg" alt="Karate Kid Legends" className="w-full max-w-xs mx-auto md:max-w-none h-auto rounded-lg shadow-lg" />
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-black mb-1">Karate Kid: Legends</h1>
        <div className="flex flex-wrap items-center gap-4 md:gap-6 text-base md:text-lg">
          <div className="flex items-center gap-2">
            <FaCalendarAlt className="text-gray-500" />
            <span className="text-gray-500">May 30, 2025</span>
          </div>
          <div className="flex items-center gap-2">
            <FaClock className="text-gray-500" />
            <span className="text-gray-500">1h 45m</span>
          </div>
        </div>
        <div className="mt-6">
          ...
          <div className="mt-2"><span className="font-bold">Director:</span> Jonathan Entwistle</div>
